...
2. **axe DevTools:** Extensión especializada para análisis profundo del árbol de accesibilidad y contraste de elementos.
...
* **Puntuación General Lighthouse:** **88 / 100** en Accesibilidad.
* **Resultado de axe DevTools:** Se identificaron y corrigieron 3 advertencias asociadas a contraste de texto, enlaces vacíos y falta de atributos descriptivos en elementos interactivos.

### **Evidencias de Auditoría Automática:**
...
![Evidencia axe DevTools](evidencia-axe.png)
*Figura 2: Verificación de reglas WCAG mediante herramientas de inspección DevTools.*
...
* **Resultado de la Herramienta:** axe DevTools marcó la regla `image-alt` como fallida.
* **Recomendación y Corrección:** Se agregaron descripciones textuales funcionales en el atributo `alt` y etiquetas `aria-label` para lectura por voz.
...
|---|---|---|---|
| **Automática** | Lighthouse / axe DevTools | Atributos `alt` faltantes, problemas de contraste CSS. | Rápida detección de reglas estándar W3C. |
